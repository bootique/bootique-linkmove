...
package io.bootique.linkmove.v2.json;
...
import io.bootique.linkmove.v2.json.cayenne.Table1;
...
public class LinkMoveJSONIT {
    ...
    static final BQRuntime app = Bootique
            .app("-c", "classpath:io/bootique/linkmove/v2/json/test.yml")
            .autoLoadModules()
            .module(db.moduleWithTestDataSource("ds"))
            .module(cayenne.moduleWithTestHooks())
            .module(b -> CayenneModule.extend(b).addProject("io/bootique/linkmove/v2/json/cayenne-project.xml"))
            .createRuntime();
