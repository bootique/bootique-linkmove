...
public class LinkMoveModule_ExtractorsConfigIT {
    ...
    private static final ExtractorName EXTRACTOR_NAME = ExtractorName.create("extractor.xml", ExtractorName.DEFAULT_NAME);
    ...
    public void configuration_ExtractorsDir_File() throws IOException, InterruptedException {
        ...
        File targetFolder = new File("target/extractors/io/bootique/linkmove/v4/folder");
        ...
        Files.copy(
                Paths.get("src/test/resources/io/bootique/linkmove/v4/folder/extractor1.xml"),
                targetFile.toPath());

        ExtractorModelTester tester = tester("classpath:io/bootique/linkmove/v4/extractorsInFilesystemFolder.yml")
                .assertBasics()
        ...
        Thread.sleep(1100);
        Files.copy(
                Paths.get("src/test/resources/io/bootique/linkmove/v4/folder/extractor2.xml"),
                targetFile.toPath());
    ...
    public void configuration_ExtractorsDir_Classpath() {
        tester("classpath:io/bootique/linkmove/v4/extractorsInClasspathFolder.yml")
                .assertBasics()
    ...
    public void configuration_ExtractorsDir_Classpath_InJar() {
        ...
        tester("classpath:io/bootique/linkmove/v4/extractorsInJar.yml")
                .assertBasics()
    ...
    class ExtractorModelTester {
        ...
        ExtractorModelTester assertPropertyPresent(String property) {
            assertNotNull(getModel().getPropertyValue(property));
            return this;
        }

        ExtractorModelTester assertPropertyAbsent(String property) {
            assertNull(getModel().getPropertyValue(property));
            return this;
        }
    }
}
