...
public class LinkMoveModule_ExtractorsConfigIT {
    ...
    public void configuration_ExtractorsDir_File() throws IOException, InterruptedException {
        ...
        Files.copy(
                Paths.get("src/test/resources/io/bootique/linkmove/v3/folder/extractor1.xml"),
                targetFile.toPath());

        ExtractorModelTester tester = tester("classpath:io/bootique/linkmove/v3/extractorsInFilesystemFolder.yml")
                .assertBasics()
        ...
        Thread.sleep(1100);
        Files.copy(
                Paths.get("src/test/resources/io/bootique/linkmove/v3/folder/extractor2.xml"),
                targetFile.toPath());
