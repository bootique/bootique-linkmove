...
import io.bootique.linkmove.rest.cayenne42.cayenne.Table1;
...
public class LinkMoveRestIT {
    ...
    static final DerbyTester db = DerbyTester.db()
            .initDB("classpath:io/bootique/linkmove/rest/cayenne42/schema.sql")
    ...
    public void testLinkMoveRest() {
        ...
        BQRuntime lm1 = testFactory
                .app("-c", "classpath:io/bootique/linkmove/rest/cayenne42/test.yml")
                .autoLoadModules()
                .module(db.moduleWithTestDataSource("ds"))
                .module(b -> CayenneModule.extend(b).addProject("io/bootique/linkmove/rest/cayenne42/cayenne-project.xml"))
                .createRuntime();
    ...
    public void testLinkMoveRest_ResolvePathParameters() {
        ...
        BQRuntime lm2 = Bootique
                .app("-c", "classpath:io/bootique/linkmove/rest/cayenne42/test-params.yml")
                .autoLoadModules()
                .module(db.moduleWithTestDataSource("ds"))
                .module(b -> CayenneModule.extend(b).addProject("io/bootique/linkmove/rest/cayenne42/cayenne-project.xml"))
                .createRuntime();
