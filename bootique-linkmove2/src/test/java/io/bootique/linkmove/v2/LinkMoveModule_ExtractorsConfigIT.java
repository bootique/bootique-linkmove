...
public class LinkMoveModule_ExtractorsConfigIT {
    ...
    public void testConfiguration_ExtractorsDir_File() throws IOException, InterruptedException {
        ...
        File targetFolder = new File("target/extractors/io/bootique/linkmove/v2/folder");
        ...
        Files.copy(
                Paths.get("src/test/resources/io/bootique/linkmove/v2/folder/extractor1.xml"),
                targetFile.toPath());

        ExtractorModelTester tester = tester("classpath:io/bootique/linkmove/v2/extractorsInFilesystemFolder.yml")
                .assertBasics()
        ...
        Thread.sleep(1100);
        Files.copy(
                Paths.get("src/test/resources/io/bootique/linkmove/v2/folder/extractor2.xml"),
                targetFile.toPath());
    ...
    public void testConfiguration_ExtractorsDir_Classpath() {
        tester("classpath:io/bootique/linkmove/v2/extractorsInClasspathFolder.yml")
                .assertBasics()
    ...
    public void testConfiguration_ExtractorsDir_Classpath_InJar() {
        ...
        tester("classpath:io/bootique/linkmove/v2/extractorsInJar.yml")
                .assertBasics()
